...
# Example: ndd.henderiw.be/ndd-provider-sros-catalog:$VERSION.
IMAGE_TAG_BASE ?= henderiw/ndd-provider-sros

# Image URL to use all building/pushing image targets
#IMG ?= henderiw/ndd-provider-sros-controller:latest
...
package-build: ## build ndd package.
	rm -rf package/ndd-provider*
	cd package;kubectl ndd provider build;cd ..

package-push: ## build ndd package.
	cd package;kubectl ndd provider push ${PKG};cd ..
